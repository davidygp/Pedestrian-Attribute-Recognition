from pedestrian_attri_recog_model_dnp import AttrRecogModel
import os
import pandas as pd
...
def annotate_images_under_directory(image_data_path):
    ...
    df.to_csv(image_data_path + '_annotated_18092020.csv')
...
def convert_dataframe_to_zero_and_one():
    ...
    data = pd.read_csv(image_data_path + '_annotated_18092020.csv')
    ...
    data.to_csv(image_data_path + '_annotated_zero_one_18092020.csv')
